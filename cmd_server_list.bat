...
::The only purpose of this file is that I already assigned commands to these, as opposed to the ms_telemetry_list.txt
::A bit lazy but functional and still clean (-ish).
...
echo 0.0.0.0 api.msn.com >> %SystemRoot%\System32\drivers\etc\hosts
echo 0.0.0.0 ris.api.iris.microsoft.com >> %SystemRoot%\System32\drivers\etc\hosts
echo 0.0.0.0 umwatson.events.data.microsoft.com >> %SystemRoot%\System32\drivers\etc\hosts
echo 0.0.0.0 check.appexec.microsoft.com >> %SystemRoot%\System32\drivers\etc\hosts
echo 0.0.0.0 umwatson.events.data.microsoft.com >> %SystemRoot%\System32\drivers\etc\hosts
echo 0.0.0.0 clients.config.office.net >> %SystemRoot%\System32\drivers\etc\hosts
