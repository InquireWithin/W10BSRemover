...
@echo off
@rem *** Disable Some Services, SpyWare & Telemetry from destroying your HDD by indexing & sending data to MS Servers on an idle PC ***
#sc stop DiagTrack
...
REM
REMDisabling Cortana this way on Version 1703 (RS2) will render all items in the Start Menu unavailable.
REMSo this is commented out for now until a better solution is found.
